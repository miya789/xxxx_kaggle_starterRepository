...
| Agent | Model | Purpose |
|---|---|---|
| kaggle-researcher | haiku | Paper, similar competition, and discussion research (low cost) |
...
このテンプレートは**日本語**と**英語**に対応しています。セットアップスクリプトで切り替え:

```bash
./setup.sh ja   # 日本語（デフォルト）
./setup.sh en   # English
```

更新対象: `CLAUDE.md`, `KAGGLE_DIRECTION.md`, エージェント定義, スキル定義, テンプレート
